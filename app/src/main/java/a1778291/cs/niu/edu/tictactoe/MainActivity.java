...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponents(){
        ...
        initLines();
        // Button
        Button rstBtn=(Button) findViewById(R.id.button);
...
//        Log.d(TAG, "Marked and updated!");
        whoWon();
        if(this.turnId==plyrId) this.turnId=sysId;
        else this.turnId=plyrId;
    }

    //Try marking box

    private void tryMarking(View v){
    ...
    private void updateImage(ImageView tv, int turnId){
        if(turnId==plyrId) tv.setImageResource(R.drawable.cross);
        else tv.setImageResource(R.drawable.circle);
    }
    ...
    private void clearBoard(){
        ...
        for(ImageView img: imagesArray){
            img.setImageResource(R.drawable.unmarked);
        }
        initMap();
        initLines();
        gameStatus.setText(R.string.onGoing);
    }
